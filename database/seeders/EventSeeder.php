    ...
    public function run()
    {
        ...
        $data = [
            ...
            2 => [
                ...
                'next_events' => [Event::APP_EVENT_FINAL_DECISION],
                'id' => 2,
                'app_event' => 2,
                'app_status' => 3,
                'extend_terms_reason_id' => null,
            ...
            Event::APP_EVENT_FINAL_DECISION => [
                'name' => [
                    'bg' => 'Крайно решение',
                    'en' => 'Final decision',
                ],
                'next_events' => [Event::APP_EVENT_FINAL_DECISION],
                'id' => Event::APP_EVENT_FINAL_DECISION,
                'app_event' => Event::APP_EVENT_FINAL_DECISION,
                'app_status' => null,
                'extend_terms_reason_id' => null,
                'days' => null,
                'date_type' => null,
            ...
            9 => [
                ...
                'next_events' => [1,2,4,5,Event::APP_EVENT_FINAL_DECISION,7,8],
                'id' => 9,
                'app_event' => 9,
                'app_status' => 1,
                'extend_terms_reason_id' => null,
            ...
            11 => [
                'name' => [
                    'bg' => 'Препращане към подчинен субект',
                    'en' => 'Application Forwarding to subordinate',
                ],
            ...
            12 => [
                'name' => [
                    'bg' => 'Препращане към подчинен субект (извън платформата)',
                    'en' => 'Application Forwarding to not registered subordinate',
                ],
                'next_events' => [1],
                'id' => 12,
                'app_event' => 12,
            ...
            13 => [
                'name' => [
                    'bg' => 'Препращане към субект извън платформата',
                    'en' => 'Application Forwarding to registered',
                ],
                'next_events' => [1],
                'id' => 13,
                'app_event' => 13,
