                        ...
                        <div class="tab-pane fade" id="tech-support" role="tabpanel" aria-labelledby="tech-support-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p>
                                        <strong>{{ __('custom.responsible_organization') }}</strong>: {{ __('custom.asap_ltd') }}
                                    </p>

                                    <p class="mb-0">
                                        <strong>{{ __('custom.technical_support_email') }}</strong>:   <script type="text/javascript"  nonce="2726c7f26c">
