...
@section('content')
    <section class="content container">
        <div class="page-title mb-md-5 mb-2 px-5">
            <h3 class="b-1 text-center">Моят профил</h3>
        </div>
        <form method="post" action="{{ route('profile') }}">
            ...
            <div class="card card-light mb-4">
                <div class="card-header app-card-header py-1 pb-0">
                    <h4 class="fs-5"><i class="fa-solid fa-user-large me-2"></i> Основни данни</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group form-group-sm col-12 mb-3">
                            @php($legalForm = old('legal_form', $user->legalForm ? $user->legalForm : \App\Models\User::USER_TYPE_PERSON))
                        ...
                        <div class="form-group form-group-sm col-md-4 col-12 mb-3">
                            <label class="form-label fw-semibold">Ел. поща: <span class="required">*</span></label>
                        ...
                        <div class="form-group form-group-sm col-md-3 col-12 mb-3">
                            ...
                            <select class="form-control form-control-sm @error('profile_type') is-invalid @endif" name="profile_type">
            ...
            <div class="card card-light mb-4">
                <div class="card-header app-card-header py-1 pb-0">
                    <h4 class="fs-5"><i class="fa-solid fa-address-card me-2"></i> Адрес за кореспонденция</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group form-group-sm col-md-3 col-12 mb-3">
                        ...
                        <div class="form-group form-group-sm col-md-3 col-12 mb-3">
                            ...
                            <select class="form-control form-control-sm @error('area') is-invalid @enderror" name="area" required>
                        ...
                        <div class="form-group form-group-sm col-md-3 col-12 mb-3">
                            ...
                            <select class="form-control form-control-sm @error('municipality') is-invalid @enderror" name="municipality" required>
                        ...
                        <div class="form-group form-group-sm col-md-3 col-12 mb-3">
                            ...
                            <select class="form-control form-control-sm @error('settlement') is-invalid @enderror" name="settlement" required>
