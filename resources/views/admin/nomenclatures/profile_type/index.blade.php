...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @include('admin.partial.filter_form', ['canExport' => 1])
            ...
            <div class="card">
                <div class="card-body table-responsive">
                    ...
                    <div class="mb-3">
                        ...
                        @includeIf('partials.status', ['action' => 'App\Http\Controllers\Admin\Nomenclature\ProfileTypeController@index'])
                        ...
                        @if(isset($items) && $items->count() > 0)
                            @foreach($items as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $userLegalForms[$item->user_legal_form] }}</td>
                                    <td>
