                                ...
                                @can('update', $item)
                                    ...
                                    <form class=" mb-3" action="post">
                                        ...
                                        <div class="input-group col-md-6 col-12">
                                            <select class="form-select form-select-sm" aria-label="Example select with button addon">
                                                <option>{{ __('custom.available_actions') }}</option>
                                                <option>Искане на допълнителна информация</option>
                                                <option>Препращане на заявление</option>
                                                <option>Удължаване на срок</option>
                                                <option>Крайно решение</option>
                                            </select>
                                            <button id="apply" type="submit" class="btn btn-sm btn-success">{{ __('custom.apply') }}</button>
                                        </div>
                                    </form>
                                @endcan
                            </div>
