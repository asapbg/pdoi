...
class PdoiApplicationPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PdoiApplication $pdoiApplication)
    {
        return false;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PdoiApplication $pdoiApplication)
    {
        return false;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PdoiApplication $pdoiApplication)
    {
        return false;
    }
}
