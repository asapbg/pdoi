            ...
            case PdoiSubjectDeliveryMethodsEnum::SEOS->value: //деловодна система
                ...
                if( $senderInfo && $receiver && $service) {
                    $egovMessage = new EgovMessage([
                        ...
                        'doc_date' => Carbon::parse($this->application->created_at, 'UTC')->format('Y-m-d')
                    ]);
                    $egovMessage->save();
                    if( $egovMessage->id ) {
