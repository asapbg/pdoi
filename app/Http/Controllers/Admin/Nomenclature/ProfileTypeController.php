...
class ProfileTypeController extends AdminController
{
    ...
    public function edit(Request $request, ProfileType $item)
    {
        ...
        $title = $item->id > 0 ? __('custom.edit_object', ['object' => trans_choice('custom.nomenclature.profile_type', 1), 'object_name' => $item->name]) : __('custom.create_object', ['object' => trans_choice('custom.nomenclature.profile_type', 1)]);
