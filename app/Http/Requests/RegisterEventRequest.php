...
class RegisterEventRequest extends FormRequest
{
    ...
    {
        if(request()->input('event') == ApplicationEventsEnum::FINAL_DECISION->value){
            return [
                'add_text.required_without' => 'Полето Предоставена обществена информация е задължително, ако не е приложен файл с търсената информация',
                'files.required_without' => 'Полето Документи се изисква, когато Предоставена обществена информация не е попълнена.'
            ];
        } else{
