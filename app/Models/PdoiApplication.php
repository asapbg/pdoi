...
//    }
    ...
    public function communication($request)
    {
        $perPage = 8;
        $page = $request->input('page_c') ? (int)$request->input('page_c') : 1;
        ...
        $result['last_page'] = $result['total'] ? (int)ceil($result['total'] / $perPage) : 0;
        return $result;
//        return DB::select('
//            select *
//            from (
