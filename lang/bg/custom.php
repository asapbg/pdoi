...
return [
    ...
    'technical_support'  => 'При срив в системата',
    'technical_support_email'  => 'Имейл',
    'technical_support_text'  => 'В случай на срив в системата, моля, свържете се с нашия екип за техническа поддръжка.',
];
