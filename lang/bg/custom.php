...
return [
    ...
    'rzs.redirect_only.tooltip'                 => 'Субект ще е достъпен само за служебно пренасочване по компетентност от страна на администратори-модератори. <br><span class="font-italic text-primary">(Директно адресиране на заявления от страна на потребители няма да е достъпно)</span>',
    ...
    'nomenclature.change_decision_reason' => "Причина за промяна на крайно решение|Причини за промяна на крайно решение",
    //delivery_methods
    ...
    'manual_register' => 'Ръчно регистриране' ,
    'asap_ltd' => 'АСАП ЕООД' ,
    'responsible_organization'  => 'Отговаряща организация',
    'admin_support'  => 'Административна поддръжка' ,
    'admin_support_text'  => 'За съдействие при търсене на специфична информация от определен задължен субект, можете да се обърнете към модераторите на платформата:' ,
    'technical_support'  => 'Техническа поддръжка',
    'technical_support_email'  => 'Имейл за техническа поддръжка',
    'technical_support_text'  => 'Ако срещнете технически проблеми при използването на платформата, моля, свържете се с нашия екип за техническа поддръжка.',
];
