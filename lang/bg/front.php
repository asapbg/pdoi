...
return [
    ...
    //login page
    'username_email' => 'Потребителско име (email)',
    ...
    'need_info_end_date' => 'Краен срок за предоставяне на информацията',
    'need_info_message' => 'На :date е заявена нужда от допълнителна информация във връзка с постъпило от Вас заявление.',
    'info_is_send' => 'Информацията е изпратена успешно',
    //home page
    ...
    'documents' => 'Нормативни документи: закони, инструкции, наредби.',
    //statistic
