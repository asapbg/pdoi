...
return [
    ...
    'search_by_name_or_pick_from_list' => 'Търсене по име или избери от списък',
    ...
    'next_btn' => 'Продължи',
    'public' => 'публикуване',
    'pick_from_list_btn' => 'Посочване от списък',
    //footer
    ...
    //login page
    'username_email' => 'Потребителск име (email)',
    'do_not_have_account' => 'Не сте регистриран?',
    'already_have_account' => 'Вече сте регистриран?',
    //my profile
    'profile.title.my_profile' => 'Моят профил',
    'profile.base_info_section' => 'Основни данни',
    'profile.address_info_section' => 'Адрес за кореспонденция',
    'profile.person_identity_tooltip' => 'Необходимо при уведомяване и връчване на документи чрез системата за сигурно електронно връчване (ССЕВ)',
    ...
    //application apply
    'application.view.title' => 'Преглед на зяавление',
    ...
    'application.files_description' => 'Могат да бъдат прикачвани файлове от следните типове: doc, docx, xsl, xslx, pdf с максимален размер до '.displayBytes(config('filesystems.max_upload_file_size')).'.',
    ...
    'documents' => 'Нормативни документи: закони, инструции, наредби.',
    //statistic
    'statistics' => 'Статистика|Статистики',
    'statistic.type.TYPE_APPLICATION_MONTH' => 'Статистика за подадени заявления по задължен субект, тип заявител и статус - месечна база',
    'statistic.type.TYPE_APPLICATION_STATUS_SIX_MONTH' => 'Статистика за подадените чрез платформата за достъп до обществена информация заявления - по полугодия',
    'statistic.type.TYPE_APPLICATION_STATUS_TOTAL' => 'Статистика за подадените чрез платформата за достъп до обществена информация заявления - общо',
];
